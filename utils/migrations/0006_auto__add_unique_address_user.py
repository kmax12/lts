...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Address', fields ['user']
        db.create_unique('utils_address', ['user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Address', fields ['user']
        db.delete_unique('utils_address', ['user_id'])
