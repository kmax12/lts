...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('utils_giftmodel', (
            ...
            ('subscription', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='gift', null=True, to=orm['utils.Subscription'])),
    ...
    models = {
        ...
        'utils.giftmodel': {
            'Meta': {'object_name': 'GiftModel', '_ormbases': ['utils.Subscription']},
            'code': ('django.db.models.fields.CharField', [], {'default': '0', 'max_length': '8'}),
            'subscription': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'gift'", 'null': 'True', 'to': "orm['utils.Subscription']"}),
            'subscription_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['utils.Subscription']", 'unique': 'True', 'primary_key': 'True'})
        },
        'utils.order': {
