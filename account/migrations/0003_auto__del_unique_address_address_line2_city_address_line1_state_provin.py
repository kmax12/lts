...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique('account_address', ['address_line2', 'city', 'address_line1', 'state_province', 'postal_code', 'country'])


    def backwards(self, orm):
        # Adding unique constraint on 'Address', fields ['address_line2', 'city', 'address_line1', 'state_province', 'postal_code', 'country']
        db.create_unique('account_address', ['address_line2', 'city', 'address_line1', 'state_province', 'postal_code', 'country'])
