...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Card.owner'
        db.alter_column('account_card', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Card.owner'
        raise RuntimeError("Cannot reverse this migration. 'Card.owner' and its values cannot be restored.")
