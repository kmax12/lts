...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Category', fields ['url_slug']
        db.create_unique('lifetime_category', ['url_slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Category', fields ['url_slug']
        db.delete_unique('lifetime_category', ['url_slug'])
    ...
    models = {
        ...
        'lifetime.gift': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'woAVgrdU'", 'unique': 'True', 'max_length': '8'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
