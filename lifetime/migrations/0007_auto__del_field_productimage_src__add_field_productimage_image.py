...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('lifetime_productimage', 'image',
                      self.gf('django.db.models.fields.TextField')(default='asd'),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ProductImage.src'
        raise RuntimeError("Cannot reverse this migration. 'ProductImage.src' and its values cannot be restored.")
    ...
    models = {
        ...
        'lifetime.gift': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'sT55yiz3'", 'unique': 'True', 'max_length': '8'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
