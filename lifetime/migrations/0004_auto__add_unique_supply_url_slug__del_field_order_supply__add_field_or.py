...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Supply', fields ['url_slug']
        db.create_unique('lifetime_supply', ['url_slug'])

        # Deleting field 'Order.supply'
        db.delete_column('lifetime_order', 'supply_id')

        # Adding field 'Order.subscription'
        db.add_column('lifetime_order', 'subscription',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['lifetime.Subscription']),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'Supply', fields ['url_slug']
        db.delete_unique('lifetime_supply', ['url_slug'])


        # User chose to not deal with backwards NULL issues for 'Order.supply'
        raise RuntimeError("Cannot reverse this migration. 'Order.supply' and its values cannot be restored.")
    ...
    models = {
        ...
        'lifetime.gift': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'kESxwAp4'", 'unique': 'True', 'max_length': '8'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
