...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Gift.claimed'
        db.add_column('lifetime_gift', 'claimed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Gift.claimed'
        db.delete_column('lifetime_gift', 'claimed')
    ...
    models = {
        ...
        'lifetime.gift': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'8c8fLJxn'", 'unique': 'True', 'max_length': '8'}),
