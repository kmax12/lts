...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Supply.url_slug'
        db.add_column('lifetime_supply', 'url_slug',
                      self.gf('django.db.models.fields.CharField')(default=2, max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Supply.url_slug'
        db.delete_column('lifetime_supply', 'url_slug')
    ...
    models = {
        ...
        'lifetime.gift': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'NtkSVLlp'", 'unique': 'True', 'max_length': '8'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
