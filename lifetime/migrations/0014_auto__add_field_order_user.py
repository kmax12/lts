...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('lifetime_order', 'user',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('lifetime_order', 'user_id')
    ...
    models = {
        ...
        'lifetime.gift': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'iQmbzaqo'", 'unique': 'True', 'max_length': '8'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
