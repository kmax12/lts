...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('lifetime_gift', 'from_name',
                      self.gf('django.db.models.fields.CharField')(default='a', max_length=100),
                      keep_default=False)

        # Adding field 'Gift.to_email'
        db.add_column('lifetime_gift', 'to_email',
                      self.gf('django.db.models.fields.EmailField')(default='a', max_length=75),
                      keep_default=False)

        # Adding field 'Gift.message'
        db.add_column('lifetime_gift', 'message',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('lifetime_gift', 'from_name')

        # Deleting field 'Gift.to_email'
        db.delete_column('lifetime_gift', 'to_email')

        # Deleting field 'Gift.message'
        db.delete_column('lifetime_gift', 'message')
    ...
    models = {
        ...
        'lifetime.gift': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'VEM8RHeq'", 'unique': 'True', 'max_length': '8'}),
