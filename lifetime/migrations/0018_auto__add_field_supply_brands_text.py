...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Supply.brands_text'
        db.add_column('lifetime_supply', 'brands_text',
                      self.gf('django.db.models.fields.CharField')(default='Colgate, Crest, Listerine, Johnson & Johnson', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Supply.brands_text'
        db.delete_column('lifetime_supply', 'brands_text')
    ...
    models = {
        ...
        'lifetime.gift': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'A9Dbj1cr'", 'unique': 'True', 'max_length': '8'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
