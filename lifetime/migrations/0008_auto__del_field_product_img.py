...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Product.img'
        db.delete_column('lifetime_product', 'img')


    def backwards(self, orm):
        # Adding field 'Product.img'
        db.add_column('lifetime_product', 'img',
                      self.gf('django.db.models.fields.CharField')(default='/img/default_product.jpg', max_length=100),
                      keep_default=False)
    ...
    models = {
        ...
        'lifetime.gift': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'OVR5sPGJ'", 'unique': 'True', 'max_length': '8'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
