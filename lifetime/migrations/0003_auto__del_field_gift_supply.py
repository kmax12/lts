...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Gift.supply'
        db.delete_column('lifetime_gift', 'supply_id')

        # Adding M2M table for field supplies on 'Gift'
        db.create_table('lifetime_gift_supplies', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('gift', models.ForeignKey(orm['lifetime.gift'], null=False)),
            ('supply', models.ForeignKey(orm['lifetime.supply'], null=False))
        ))
        db.create_unique('lifetime_gift_supplies', ['gift_id', 'supply_id'])


    def backwards(self, orm):
        # Adding field 'Gift.supply'
        db.add_column('lifetime_gift', 'supply',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lifetime.Supply'], null=True, blank=True),
                      keep_default=False)

        # Removing M2M table for field supplies on 'Gift'
        db.delete_table('lifetime_gift_supplies')
    ...
    models = {
        ...
        'lifetime.gift': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'uKwLnEe4'", 'unique': 'True', 'max_length': '8'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'supplies': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['lifetime.Supply']", 'null': 'True', 'blank': 'True'})
        },
        'lifetime.order': {
