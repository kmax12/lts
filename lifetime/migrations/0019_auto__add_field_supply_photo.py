...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Supply.photo'
        db.add_column('lifetime_supply', 'photo',
                      self.gf('django.db.models.fields.CharField')(default='/', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Supply.photo'
        db.delete_column('lifetime_supply', 'photo')
    ...
    models = {
        ...
        'lifetime.gift': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'TfAJQj4M'", 'unique': 'True', 'max_length': '8'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
