...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Order.subscription'
        db.delete_column('lifetime_order', 'subscription_id')
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Order.subscription'
        raise RuntimeError("Cannot reverse this migration. 'Order.subscription' and its values cannot be restored.")
    ...
    models = {
        ...
        'lifetime.gift': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'gbvsczNX'", 'unique': 'True', 'max_length': '8'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'lifetime.order': {
            ...
            'subscriptions': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['lifetime.Subscription']", 'symmetrical': 'False'})
        },
        'lifetime.product': {
