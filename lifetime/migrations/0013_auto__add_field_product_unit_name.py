...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.unit_name'
        db.add_column('lifetime_product', 'unit_name',
                      self.gf('django.db.models.fields.CharField')(default='units', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.unit_name'
        db.delete_column('lifetime_product', 'unit_name')
    ...
    models = {
        ...
        'lifetime.giftmodel': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'3l8ksB7B'", 'unique': 'True', 'max_length': '8'}),
