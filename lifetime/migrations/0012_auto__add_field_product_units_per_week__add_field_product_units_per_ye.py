...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.units_per_week'
        db.add_column('lifetime_product', 'units_per_week',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Product.units_per_year'
        db.add_column('lifetime_product', 'units_per_year',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.units_per_week'
        db.delete_column('lifetime_product', 'units_per_week')

        # Deleting field 'Product.units_per_year'
        db.delete_column('lifetime_product', 'units_per_year')
    ...
    models = {
        ...
        'lifetime.giftmodel': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'ub46MPuJ'", 'unique': 'True', 'max_length': '8'}),
        ...
        'lifetime.product': {
            ...
            'units_per_week': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'units_per_year': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },
