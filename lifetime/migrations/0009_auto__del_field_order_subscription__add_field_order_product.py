...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Order.product'
        db.add_column('lifetime_order', 'product',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['lifetime.Product']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Order.product'
        db.delete_column('lifetime_order', 'product_id')
    ...
    models = {
        ...
        'lifetime.gift': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'8Kd5eOnJ'", 'unique': 'True', 'max_length': '8'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
