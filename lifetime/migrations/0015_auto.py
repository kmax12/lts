...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing M2M table for field subscriptions on 'Order'
        db.delete_table('lifetime_order_subscriptions')

        # Adding M2M table for field subscriptions_used on 'Order'
        db.create_table('lifetime_order_subscriptions_used', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('order', models.ForeignKey(orm['lifetime.order'], null=False)),
            ('subscription', models.ForeignKey(orm['lifetime.subscription'], null=False))
        ))
        db.create_unique('lifetime_order_subscriptions_used', ['order_id', 'subscription_id'])


    def backwards(self, orm):
        # Adding M2M table for field subscriptions on 'Order'
        db.create_table('lifetime_order_subscriptions', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('order', models.ForeignKey(orm['lifetime.order'], null=False)),
            ('subscription', models.ForeignKey(orm['lifetime.subscription'], null=False))
        ))
        db.create_unique('lifetime_order_subscriptions', ['order_id', 'subscription_id'])

        # Removing M2M table for field subscriptions_used on 'Order'
        db.delete_table('lifetime_order_subscriptions_used')
    ...
    models = {
        ...
        'lifetime.gift': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'BddsufZJ'", 'unique': 'True', 'max_length': '8'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'lifetime.order': {
            ...
            'subscriptions_used': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['lifetime.Subscription']", 'symmetrical': 'False'}),
