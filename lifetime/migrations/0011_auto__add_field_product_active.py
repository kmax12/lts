...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('lifetime_product', 'active',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('lifetime_product', 'active')
    ...
    models = {
        ...
        'lifetime.giftmodel': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'MyQEmDCD'", 'unique': 'True', 'max_length': '8'}),
