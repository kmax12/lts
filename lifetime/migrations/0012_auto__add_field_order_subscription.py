...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('lifetime_order', 'subscription',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['lifetime.Subscription']),
                      keep_default=False)
    ...
    models = {
        ...
        'lifetime.gift': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'oBVrdP8o'", 'unique': 'True', 'max_length': '8'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
