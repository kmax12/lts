...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('lifetime_address', 'user_id')

        # Adding field 'Address.owner'
        db.add_column('lifetime_address', 'owner',
    ...
    def backwards(self, orm):
        ...
        db.add_column('lifetime_address', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_obj', unique=True, null=True, to=orm['auth.User'], blank=True),
                      keep_default=False)

        # Deleting field 'Address.owner'
        db.delete_column('lifetime_address', 'owner_id')
    ...
    models = {
        ...
        'lifetime.giftmodel': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'r5m0AWhu'", 'unique': 'True', 'max_length': '8'}),
