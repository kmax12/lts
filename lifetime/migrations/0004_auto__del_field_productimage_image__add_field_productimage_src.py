...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('lifetime_productimage', 'image')

        # Adding field 'ProductImage.src'
        db.add_column('lifetime_productimage', 'src',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'ProductImage.image'
        raise RuntimeError("Cannot reverse this migration. 'ProductImage.image' and its values cannot be restored.")
        # Deleting field 'ProductImage.src'
        db.delete_column('lifetime_productimage', 'src')
    ...
    models = {
        ...
        'lifetime.gift': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'2zFHHD2O'", 'unique': 'True', 'max_length': '8'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'lifetime.productimage': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lifetime.Product']"}),
            'src': ('django.db.models.fields.TextField', [], {})
        },
