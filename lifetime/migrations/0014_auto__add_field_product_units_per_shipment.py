...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.units_per_shipment'
        db.add_column('lifetime_product', 'units_per_shipment',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.units_per_shipment'
        db.delete_column('lifetime_product', 'units_per_shipment')
    ...
    models = {
        ...
        'lifetime.giftmodel': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'TxlCYYSA'", 'unique': 'True', 'max_length': '8'}),
        ...
        'lifetime.product': {
            ...
            'unit_name': ('django.db.models.fields.CharField', [], {'default': "'units'", 'max_length': '100'}),
            'units_per_shipment': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
