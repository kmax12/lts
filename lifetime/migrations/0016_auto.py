...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field subscription on 'Order'
        db.create_table('lifetime_order_subscription', (
        ...
        db.create_unique('lifetime_order_subscription', ['order_id', 'subscription_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field subscription on 'Order'
        db.delete_table('lifetime_order_subscription')
    ...
    models = {
        ...
        'lifetime.gift': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'n3ubsQoc'", 'unique': 'True', 'max_length': '8'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'lifetime.order': {
            ...
            'subscription': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['lifetime.Subscription']", 'symmetrical': 'False'}),
